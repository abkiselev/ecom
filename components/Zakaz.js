    ...
    <section className={styles.zakaz}>
      ...
      <div className={styles.zakaz_container}>
          ...
          <div className={styles.zakaz_descr}>
            ...
            <p className={styles.zakaz_text}>Пошью ремень под цвет вашей сумочки. Подберем стропу из более 500 вариантов, фурнитуру из более 300 вариантов.</p>
            <p className={styles.zakaz_text}>Текстильный ремень с кожаными вставками из итальянской кожи в наличии и под заказ.</p>
